        ...
        {variant === "glow" && (
          <>
            <motion.div
              ...
              {...{ style: { y: y1, scale, background: "radial-gradient(circle, hsla(18,100%,50%,0.15), transparent 70%)" } }}
            />
            <motion.div
              style={{ y: y2 }}
        ...
        {variant === "grid" && (
          <>
            <motion.div
              ...
              {...{ style: { y: y1, backgroundImage: "linear-gradient(hsla(18,100%,50%,0.12) 1px, transparent 1px), linear-gradient(90deg, hsla(18,100%,50%,0.12) 1px, transparent 1px)", backgroundSize: "60px 60px" } }}
            />
            <motion.div
              style={{ y: y3, rotate }}
        ...
        {variant === "orbs" && (
          <>
            <motion.div
              ...
              {...{ style: { y: y1, scale, background: "radial-gradient(circle, hsla(18,100%,50%,0.1), transparent 70%)", filter: "blur(40px)" } }}
            />
            <motion.div
              style={{ y: y2, x: 20 }}
            ...
            <motion.div
              ...
              {...{ style: { y: y3, background: "radial-gradient(circle, hsla(18,80%,50%,0.06), transparent 70%)", filter: "blur(30px)" } }}
            />
          </>
        )}
