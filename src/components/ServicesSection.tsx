...
const services = [
  ...
  {
    icon: Brain,
    title: "יצירה ללא גבולות",
    verse: "עֹשֶׂה גְדֹלוֹת עַד אֵין חֵקֶר, וְנִפְלָאוֹת עַד אֵין מִסְפָּר",
    subtitle: "AI & Development",
    bullets: [
      { icon: Bot, text: "פרזנטורים ומשפיעניות AI (UGC): יצירת דמויות וירטואליות אנושיות לחלוטין שמייצרות סרטוני המלצה ופרסומות למותג שלכם – בלי לשלם הון עתק לטאלנטים ולימי צילום" },
      { icon: Zap, text: "קריאייטיב ותמונות AI: הפקת תוכן ויזואלי ברמת פרימיום. מתמונות קמפיין ועד עיצובים מרהיבים שעוצרים את הגלילה ומייצרים קליקים" },
      { icon: BarChart3, text: "מצגות עסקיות חכמות: בניית מצגות משקיעים, פיצ׳ים ומכירות בעזרת AI. מעבירים את המסר שלכם בצורה חדה ומשכנעת שסוגרת עסקאות" },
      { icon: TrendingUp, text: "משהו שלא הזכרנו? פתרונות טכנולוגיים מותאמים אישית כדי שתעבדו חכם יותר ותעקפו את המתחרים" },
    ],
    tags: ["UGC", "קריאייטיב", "מצגות", "AI"],
    tagHue: 10,
  },
  {
    icon: Megaphone,
    title: "להגדיל תורה ולהאדירה: מיתוג וצמיחה לרבנים",
    verse: "יַגְדִּיל תּוֹרָה וְיַאְדִּיר",
    subtitle: "Spiritual Branding & Growth",
    bullets: [
      { icon: Globe, text: "בניית נוכחות דיגיטלית מקיפה לרבנים ומנהיגים רוחניים" },
      { icon: TrendingUp, text: "בניית קהילות גדולות וצומחות ברשתות החברתיות" },
      { icon: Zap, text: "אופטימיזציית תוכן וקידום בעל השפעה גבוהה להפצת אור התורה בכל העולם" },
      { icon: Megaphone, text: "מיתוג אישי ואסטרטגיית תוכן מותאמת למנהיגים רוחניים" },
    ],
    tags: ["מיתוג", "רבנים", "קהילות", "תורה"],
    tagHue: 18,
  },
];
